...
export interface StepsProps extends Partial<Omit<BoxProps<Theme>, 'color'>>{
    ...
    <Box flexDirection="row" justifyContent="space-between" {...rest}>
      ...
      {stepsLabels.map((label, index)=>{
        ...
        const onBgColor = progressAnimatedValueRef.current.interpolate({
          ...
          return (
            <AnimatedBox key={`step-${label}`} {...stepBoxProps} style={[stepsTheme as unknown as RegisteredStyle<ViewStyle>,{backgroundColor: bgColor}]}>
